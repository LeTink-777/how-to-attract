# Гайд как влюбить в себя

Воронка на Next.js 16 (App Router, TypeScript, Tailwind CSS 4) с оплатой через ЮKassa.

Прод: https://how-to-attract.vercel.app

## Тарифы

| Тариф | Цена | Было | Доставка |
| --- | --- | --- | --- |
| Старт | 390 ₽ | ~~1490 ₽~~ | 24 часа |
| Полный гайд | 790 ₽ | ~~3490 ₽~~ | 12 часов |
| Максимум | 1590 ₽ | ~~5900 ₽~~ | 6 часов |
...
Вебхук ЮKassa: `POST https://how-to-attract.vercel.app/api/payment/webhook`.
