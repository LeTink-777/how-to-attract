...
const displayFont = Playfair_Display({ variable: "--ff-display", subsets: ["latin", "cyrillic"], display: "swap" });
const bodyFont = Nunito({ variable: "--ff-body", subsets: ["latin", "cyrillic"], display: "swap" });
